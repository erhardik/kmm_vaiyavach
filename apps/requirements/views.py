...
class RequirementCollectionView(View):
    ...
    def _build_context(self, request, event, header, form, formset, items, existing_quantities=None):
        ...
        return {
            ...
            "public_pdf_en_url": _with_lang(reverse("requirements:public-print", kwargs={"token": header.public_view_token}), "full") if header and header.order_number else None,
    ...
    def get(self, request, pk=None, token=None):
        ...
        return render(
            ...
            "requirements/header_detail.html" if request.headers.get("x-requested-with") == "XMLHttpRequest" else "requirements/header_detail_page.html",
            {
                ...
                "public_pdf_en_url": _with_lang(reverse("requirements:public-print", kwargs={"token": header.public_view_token}), "full") if header.order_number else None,
